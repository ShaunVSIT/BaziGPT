...
function Daily() {
    ...
    const fetchDailyForecastData = async () => {
        ...
        try {
            ...
            // Track successful forecast fetch
            track('daily_forecast_fetched', {
                cached: data.cached,
                date: data.date,
            });
        } catch (err) {
    ...
    const handleShare = () => {
        ...
        track('daily_forecast_share_dialog_opened');
    };
    ...
    const handleShareDownload = async () => {
        ...
        try {
            ...
            track('daily_forecast_shared', {
                method: 'download',
            });
        } catch (error) {
            console.error('Error generating share image:', error);
            track('daily_forecast_share_error', {
    ...
    return (
        <>
            <Helmet>
                ...
                />
                <meta property="og:title" content={`Daily Bazi Forecast - ${formattedDate}`} />
                <meta property="og:description" content="Get your daily Bazi forecast for today. Discover the energy of the day and practical guidance." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content={window.location.href} />
                <meta name="twitter:card" content="summary" />
                <meta name="twitter:title" content={`Daily Bazi Forecast - ${formattedDate}`} />
                <meta name="twitter:description" content="Get your daily Bazi forecast for today." />
            </Helmet>
